  ...
  <ul class="slides">
    ...
    <li>
      ...
      <div class="caption center-align">
        <h3>Inspiração e arte!</h3>
        <h5 class="light grey-text text-lighten-3">Fotografia em família.</h5>
      </div>
    </li>
    ...
    <li>
      ...
      <div class="caption left-align">
        <h3>Aniversario infantil</h3>
        <h5 class="light grey-text text-lighten-3">Captura emoção.</h5>
      </div>
    </li>
    ...
    <li>
      ...
      <div class="caption right-align">
        <h3>Criatividade</h3>
        <h5 class="light grey-text text-lighten-3">Fotos exclusivas.</h5>
      </div>
    </li>
